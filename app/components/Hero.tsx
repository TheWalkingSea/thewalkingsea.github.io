        ...
        <div className="relative min-h-screen flex items-center justify-center pt-20 bg-gradient-to-b from-black via-blue-950/20 to-black">
            ...
            <div className="relative z-10 container mx-auto px-6 flex items-center justify-between max-w-7xl flex-col-reverse md:flex-row">
                <div className="flex-1 space-y-2 md:space-y-6 text-center md:text-left">
                    <h1 className="text-7xl font-bold font-starwars text-amber-400 drop-shadow-[0_0_20px_rgba(251,191,36,0.7)] animate-fade-in m-y-6">
                        Austin
                    </h1>
                ...
                <div className="flex-shrink-0 md:ml-12">
                    <div className="relative w-80 h-80 rounded-full overflow-hidden border-4 border-blue-400 shadow-[0_0_30px_rgba(59,130,246,0.6)] hover:shadow-[0_0_50px_rgba(59,130,246,0.8)] transition-all duration-300 mb-8 md:mb-0">
                        <img
